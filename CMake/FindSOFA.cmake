...
## ###########################################################################################
## DEFINE SOFA_DIR_SRC root path
## ###########################################################################################
if (NOT SOFA_DIR_SRC)
    set(SOFA_DIR_SRC "$ENV{SOFA_DIR_SRC}" CACHE PATH "Sofa source root directory")
endif (NOT SOFA_DIR_SRC)

## Make sur the provided path is a cmake style path with unix /
file(TO_CMAKE_PATH ${SOFA_DIR} SOFA_DIR)
file(TO_CMAKE_PATH ${SOFA_DIR_SRC} SOFA_DIR_SRC)
...
set(SOFA_INCLUDE_EXTLIBS "${SOFA_DIR_SRC}/extlibs")
list(APPEND SOFA_INCLUDE_OTHER_DIRS
    ...
    ${SOFA_INCLUDE_EXTLIBS}/libQGLViewer-2.4.0
    ${SOFA_INCLUDE_EXTLIBS}/LML
    ${SOFA_INCLUDE_EXTLIBS}/metis-5.1.0
...
if(MSVC)
    list(APPEND SOFA_INCLUDE_OTHER_DIRS ${SOFA_DIR_SRC}/include)
endif(MSVC)
